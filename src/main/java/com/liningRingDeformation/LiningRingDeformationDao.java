...
public class LiningRingDeformationDao {
	...
	public int querySizeByTunnelAndSection(int tunnelId,int tunnelSectionId,int liningRingId) {
		...
		parameters.put("liningRingId", liningRingId);
	...
	@SuppressWarnings("rawtypes")
	public List queryLimitedLiningRingDeformations(int tunnelId,int tunnelSectionId,int liningRingConstructionId,int start, int size) {
		Map<String, Object> parameters = new HashMap<String, Object>();
