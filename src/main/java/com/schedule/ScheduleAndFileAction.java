...
public class ScheduleAndFileAction extends FileUploadAction {

	private static final long serialVersionUID = 2802256599554299998L;

	private Logger m_logger = Logger.getLogger(ScheduleAndFileAction.class);
	...
	protected Schedule m_schedule = new Schedule();
