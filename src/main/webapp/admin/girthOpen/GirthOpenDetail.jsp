				...
				<table  class="table table-striped table-bordered table-condensed">
					...
					<tr>
						...
						<div id="datetimepicker1" class="input-append date">
				            <input name="girthOpen.date"  value="<s:date name="girthOpen.date" format="yyyy-MM-dd"/>"  class="{required:true,date:true}"
					...
					<tr>
						...
						<td><input type="text" name="girthOpen.measuringPoing"  value="<s:property value="girthOpen.measuringPoing"/>"  class="{required:true,maxlength:64}"/></td>
						<td style="text-align:right;"><strong class="text-success">变形值</strong></td>
						<td><input type="text" name="girthOpen.value" value="<s:property value="girthOpen.value"/>" class="{required:true,number:true}"/></td>
					</tr>
					<tr>
						<td style="text-align:right;"><strong class="text-success">简介</strong></td>
						<td colspan='3'><textarea type="text" rows="5" cols="60"  name="girthOpen.des" class="{maxlength:512}"><s:property value="girthOpen.des"/></textarea></td>
					</tr>
					</table>
			</form>
      </div>
