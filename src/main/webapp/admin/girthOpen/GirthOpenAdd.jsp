  ...
  <div class="container-fluid">
    <div class="row-fluid">
      ...
      <div class="span10">
			...
			<form action="girthOpenAddSubmit.do" id="form" method="post">
				<table  class="table table-striped table-bordered table-condensed">
					...
					<tr>
						...
						<td>
							<select name="girthOpen.serious">
								<option value="1">否</option>
								<option value="2">是</option>
							</select>
						</td>
						<td style="text-align:right;"><strong class="text-success">备注信息</strong></td>
						<td><textarea type="text" rows="5" cols="40"  name="girthOpen.des" class="{maxlength:512}"></textarea></td>
					</tr>
					<tr>
