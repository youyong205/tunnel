      ...
      <div class="span10"> 
			<div class="row-fluid"><div class="span6">
					...
					<t:privilege res="敞开段养护记录模块:详情">
	      			<a href="openSectionCuringList.do?tunnelId=<s:property value="tunnelId"/>" class="btn btn-small  btn-primary btn-success">养护记录</a>
      				</t:privilege>
      			</div>
      			<div class="span6"><form class="text-right form-inline margin-buttom" action="openSectionCuringList.do" method="post">
			  隧道
