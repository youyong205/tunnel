			...
			<form action="rectangleComponentAddSubmit.do" id="form" method="post" enctype="multipart/form-data">
				<table  class="table table-striped table-bordered table-condensed">
					...
					<tr>
						...
						<td colspan='3'>
							<select name="rectangleComponent.lineType">
					...
					<tr>
						...
						<td><input type="text" name="rectangleComponent.startPosition" class="{required:true,number:true}"/></td>
						<td style="text-align:right;"><strong class="text-success">结束里程(m)</strong></td>
						<td><input type="text" name="rectangleComponent.endPosition" class="{required:true,number:true}"/></td>
					</tr>
					<tr>
						...
						<td><textarea type="text" rows="5" cols="40"  name="rectangleComponent.des" class="{maxlength:512}"></textarea></td>
					</tr>
					</table>
