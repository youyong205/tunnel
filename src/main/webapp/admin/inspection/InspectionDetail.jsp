...
<table  class="table table-striped table-bordered table-condensed">
	...
	<tr>
		<td width="15%" style="text-align:right;"><strong class="text-success">检测时间</strong></td>
		<td width="35%">
		<div id="datetimepicker1" class="input-append date">
            <input name="inspection.time" readonly value='<s:date name="inspection.time" format="yyyy-MM-dd" />' class="{required:true,date:true}"
               data-format="yyyy-MM-dd" type="text"></input> <span class="add-on"> <i
               data-time-icon="icon-time" data-date-icon="icon-calendar"> </i>
            </span>
         </div>
        <td  width="15%" style="text-align:right;"><strong class="text-success">处理时间</strong></td>
		<td  width="35%">
		<div id="datetimepicker2" class="input-append date">
            <input name="inspection.actionTime" readonly  value='<s:date name="inspection.actionTime" format="yyyy-MM-dd" />'  class="{required:true,date:true}"
               data-format="yyyy-MM-dd" type="text"></input> <span class="add-on"> <i
               data-time-icon="icon-time" data-date-icon="icon-calendar"> </i>
            </span>
         </div>
	...
	<tr>
		...
		<td><textarea type="text" rows="5" cols="50" readonly name="inspection.description" class="{maxlength:512}"><s:property value="inspection.description"/></textarea></td>
	<td style="text-align:right;"><strong class="text-success">处理措施</strong></td>
		<td><textarea type="text" rows="5" cols="50" readonly name="inspection.action" class="{maxlength:512}"><s:property value="inspection.action"/></textarea></td>
	</tr>
	<tr>
		<td style="text-align:right;"><strong class="text-success">备注</strong></td>
		<td><textarea type="text" rows="5" cols="50" readonly name="inspection.des" class="{maxlength:512}"><s:property value="inspection.des"/></textarea></td>
	</tr>
	</table>
