...
<table  class="table table-striped table-bordered table-condensed">
	...
	<tr>
		...
		<div id="datetimepicker1" class="input-append date">
            <input name="inspection.time"  value='<s:date name="inspection.time" format="yyyy-MM-dd" />' class="{required:true,date:true}"
		...
		<div id="datetimepicker2" class="input-append date">
            <input name="inspection.actionTime"   value='<s:date name="inspection.actionTime" format="yyyy-MM-dd" />'  class="{required:true,date:true}"
               data-format="yyyy-MM-dd" type="text"></input> <span class="add-on"> <i
               data-time-icon="icon-time" data-date-icon="icon-calendar"> </i>
            </span>
         </div>
