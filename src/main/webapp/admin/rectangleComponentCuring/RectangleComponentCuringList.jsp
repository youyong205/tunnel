      		...
      		<div class="row-fluid">
      			<div class="span4">
					...
					<t:privilege res="口型构件养护记录模块:详情">
	      			<a href="rectangleComponentCuringList.do?tunnelId=<s:property value="tunnelId"/>&tunnelSectionId=<s:property value="parentTunnelSectionId"/>" class="btn btn-small  btn-primary btn-success">养护记录</a>
      				</t:privilege>
      			</div>
      			<div class="span8">
