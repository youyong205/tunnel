...
<table class="table table-striped table-bordered table-condensed">
	...
	<tr>
		...
		<td><s:select name="inspection.tunnelId" id="tunnelId"
				...
				listValue="name" value="tunnelId" theme="simple">
			</s:select></td>
	...
	<tr>
		...
		<td width="35%">
			<div id="datetimepicker1" class="input-append date">
				<input name="inspection.time" placeholder="检测时间"
		...
		<td width="35%">
			<div id="datetimepicker2" class="input-append date">
				<input name="inspection.actionTime" placeholder="检测时间"
					class="{required:true,date:true}" data-format="yyyy-MM-dd"
					type="text"></input> <span class="add-on"> <i
					data-time-icon="icon-time" data-date-icon="icon-calendar"> </i>
				</span>
	...
	<tr>
		...
		<td><textarea type="text" rows="5" cols="40"
				name="inspection.description" class="{maxlength:512}"></textarea></td>
		<td style="text-align: right;"><strong class="text-success">处理措施</strong></td>
		<td><textarea type="text" rows="5" cols="40"
				name="inspection.action" class="{maxlength:512}"></textarea></td>
	</tr>
	<tr>
		<td style="text-align: right;"><strong class="text-success">备注</strong></td>
		<td colspan='3'><textarea type="text" rows="5" cols="40"
