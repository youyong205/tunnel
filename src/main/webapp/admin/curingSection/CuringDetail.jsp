...
<table  class="table table-striped table-bordered table-condensed">
	...
	<tr>
		...
		<div id="datetimepicker1" class="input-append date">
	           <input name="curing.time"   readonly value='<s:date name="curing.time" format="yyyy-MM-dd" />' class="{required:true,date:true}"
		   ...
		   <td  width="35%">
	           <input name="curing.position" class="{required:true}" readonly value="<s:property value='curing.position'/>"  type="text"></input> 
	       </tr>
	<tr>
	...
	<tr>
		...
		<td  colspan='3'><textarea type="text" rows="5" cols="50" name="curing.des" readonly class="{maxlength:512}"><s:property value='curing.des'/></textarea></td>
	</tr>
</table>
