  ...
  <div class="container-fluid">
    <div class="row-fluid">
      ...
      <div class="span10">
			...
			<form action="liningRingLongitudinalDeformationBatchAddSubmit.do" id="form" method="post" enctype="multipart/form-data">
				...
				<table class="table table-striped table-bordered table-condensed">
					...
					<tr><td>第四列</td><td>纵向曲率ζ</td></tr>
					<tr><td>第五列</td><td>备注信息</td></tr>
				</table>
				
				<table class="table table-striped table-bordered table-condensed">
					<tr><th>衬砌环唯一编号</th><th>测量时间</th><th>测点</th><th>纵向曲率ζ</th><th>备注信息</th></tr>
