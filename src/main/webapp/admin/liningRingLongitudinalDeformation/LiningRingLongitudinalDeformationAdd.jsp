  ...
  <div class="container-fluid">
    <div class="row-fluid">
      ...
      <div class="span10">
			...
			<form action="liningRingLongitudinalDeformationAddSubmit.do" id="form" method="post">
				<table  class="table table-striped table-bordered table-condensed">
					<tr>	
						<th colspan='4'><h4 class="text-info text-center">新增衬砌环纵断面变形检测信息</h4></th>
					...
					<tr>
						...
						<div id="datetimepicker1" class="input-append date">
				            <input name="liningRingLongitudinalDeformation.date"  placeholder="检测时间"  class="{required:true,date:true}"
					...
					<tr>
						...
						<td><input type="text" name="liningRingLongitudinalDeformation.measuringPoing" class="{required:true,maxlength:64}"/></td>
						<td style="text-align:right;"><strong class="text-success">变形值</strong></td>
						<td><input type="text" name="liningRingLongitudinalDeformation.value" class="{required:true,number:true}"/></td>
					</tr>
					<tr>
						<td style="text-align:right;"><strong class="text-success">简介</strong></td>
						<td colspan='3'><textarea type="text" rows="5" cols="60"  name="liningRingLongitudinalDeformation.des" class="{maxlength:512}"></textarea></td>
					</tr>
					<tr>
