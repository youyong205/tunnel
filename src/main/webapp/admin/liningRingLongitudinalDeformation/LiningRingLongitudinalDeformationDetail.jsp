      ...
      <div class="span10">
     		<%@include file="./../MeasuringHeader.jsp"%>
				<table  class="table table-striped table-bordered table-condensed">
					<tr>	
						<th colspan='4'><h4 class="text-info text-center">衬砌环纵断面变形检测信息详情</h4></th>
					...
					<tr>
						...
						<td colspan='3'><textarea type="text" rows="5" cols="60"  name="liningRingLongitudinalDeformation.des" class="{maxlength:512}"><s:property value="liningRingLongitudinalDeformation.des"/></textarea></td>
					</tr>
					</table>
			</form>
      </div>
