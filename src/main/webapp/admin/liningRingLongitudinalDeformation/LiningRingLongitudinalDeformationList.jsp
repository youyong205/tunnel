    ...
    <div class="row-fluid">
      ...
      <div class="span10"> 
     		<%@include file="./../MeasuringHeader.jsp"%>
      		<div class="row-fluid">
      			<div class="span12">
      				<form class="text-right form-inline margin-buttom" action="liningRingLongitudinalDeformationList.do" method="post">
						<strong>选择隧道</strong>
      		...
      		<form action="liningRingLongitudinalDeformationBatchDelete.do" id="form" method="post" onsubmit="return checkForm();">
				...
				<table class="table table-striped table-bordered table-condensed table-hover">
				 <thead><tr>
					...
					<th width="5%">序号</th>
					<th width="30%">检测时间</th>
					<th width="37%">纵向曲率ζ</th>
					<th width="20%">
					<t:privilege res="衬砌环纵断面变形检测模块:新增">
						<a class="btn btn-small btn-info" href="liningRingLongitudinalDeformationAdd.do?tunnelId=<s:property value="tunnelId"/>&tunnelSectionId=<s:property value="parentTunnelSectionId"/>&liningRingConstructionId=<s:property value="liningRingConstructionId"/>&index=<s:property value="index"/>" >新增</a>
						<a class="btn btn-small btn-info" href="liningRingLongitudinalDeformationBatchAdd.do?tunnelId=<s:property value="tunnelId"/>&tunnelSectionId=<s:property value="parentTunnelSectionId"/>&liningRingConstructionId=<s:property value="liningRingConstructionId"/>&index=<s:property value="index"/>" >导入</a>
					</t:privilege>
					<t:privilege res="衬砌环纵断面变形检测模块:删除">
						<button  class="btn btn-small btn-danger" type="submit">批量删除</button></td>
					</t:privilege>
					</th>
				</tr></thead><tbody>
				<s:iterator value="liningRingLongitudinalDeformations" status="vs">
					<tr>
					...
					<td>
					<t:privilege res="衬砌环纵断面变形检测模块:详情">
						<a class="btn btn-small btn-success" href="liningRingLongitudinalDeformationDetail.do?tunnelId=<s:property value="tunnelId"/>&tunnelSectionId=<s:property value="parentTunnelSectionId"/>&liningRingLongitudinalDeformationId=<s:property value="id"/>&liningRingConstructionId=<s:property value="parentLiningRingConstructionId"/>&index=<s:property value="index"/>">详情</a>
					</t:privilege>
					<t:privilege res="衬砌环纵断面变形检测模块:编辑">
						<a class="btn btn-small btn-primary" href="liningRingLongitudinalDeformationUpdate.do?tunnelId=<s:property value="tunnelId"/>&tunnelSectionId=<s:property value="parentTunnelSectionId"/>&liningRingLongitudinalDeformationId=<s:property value="id"/>&liningRingConstructionId=<s:property value="parentLiningRingConstructionId"/>&index=<s:property value="index"/>">编辑</a>
					</t:privilege>
					<t:privilege res="衬砌环纵断面变形检测模块:删除">
						<a class="delete btn  btn-small btn-danger" href="liningRingLongitudinalDeformationDelete.do?tunnelId=<s:property value="tunnelId"/>&tunnelSectionId=<s:property value="parentTunnelSectionId"/>&liningRingLongitudinalDeformationId=<s:property value="id"/>&liningRingConstructionId=<s:property value="parentLiningRingConstructionId"/>&index=<s:property value="index"/>">删除</a>
					</t:privilege>
					</td>
					</tr>
				</s:iterator></tbody>
