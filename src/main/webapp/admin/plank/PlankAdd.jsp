...
<body>
  ...
  <div class="container-fluid">
    <div class="row-fluid">
      ...
      <div class="span10">
			<form action="plankAddSubmit.do" id="form" method="post" enctype="multipart/form-data">
				<table  class="table table-striped table-bordered table-condensed">
					<tr>	
						<th colspan='4'><h4 class="text-info text-center">新增车道板信息</h4></th>
					...
					<tr>
						...
						<td><input type="text" size="40" name="plank.name" class="{required:true,maxlength:64}"/></td>
						<td style="text-align:right;"><strong class="text-success">车道板类型</strong></td>
						<td><input type="text" size="40" name="plank.type" class="{required:true,maxlength:64}"/></td>
					</tr>
					<tr>
						<td style="text-align:right;"><strong class="text-success">混凝土强度</strong></td>
						<td><input type="text" size="40" name="plank.concreteStrength" class="{required:true,maxlength:64}"/></td>
						<td style="text-align:right;"><strong class="text-success">钢筋强度</strong></td>
						<td><input type="text" size="40" name="plank.reinforcementStrength" class="{required:true,maxlength:64}"/></td>
					</tr>
					<tr>
						<td style="text-align:right;"><strong class="text-success">设计路中</strong></td>
						<td><input type="text" size="40" name="plank.designPath" class="{required:true,maxlength:64}"/></td>
						<td style="text-align:right;"><strong class="text-success">设计纵坡</strong></td>
						<td><input type="text" size="40" name="plank.designLongitudinal" class="{required:true,maxlength:64}"/></td>
					</tr>
					<tr>
						<td style="text-align:right;"><strong class="text-success">车道板长度</strong></td>
						<td><input type="text" size="40" name="plank.length" class="{required:true,maxlength:64}"/></td>
						<td style="text-align:right;"><strong class="text-success">线路类型</strong></td>
						<td>
							<select name="plank.lineType">
					...
					<tr>
						...
						<td><input type="text" name="plank.startPosition" class="{required:true,number:true}"/></td>
						<td style="text-align:right;"><strong class="text-success">结束里程(m)</strong></td>
						<td><input type="text" name="plank.endPosition" class="{required:true,number:true}"/></td>
					</tr>
					<tr>
						...
						<td style="text-align:right;"><strong class="text-success">车道板简介</strong></td>
						<td><textarea type="text" rows="5" cols="60"  name="plank.des" class="{maxlength:512}"></textarea></td>
					</tr>
					</table>
