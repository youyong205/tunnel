    ...
    <div class="row-fluid">
      ...
      <div class="span10"> 
      		<div class="row-fluid">
      			<div class="span4">
	    	  		...
	    	  		<t:privilege res="预埋管线质量检测模块:详情">
	    	  			<a href="linePipeInspectionList.do?tunnelId=<s:property value="tunnelId"/>&tunnelSectionId=<s:property value="parentTunnelSectionId"/>" class="btn btn-small btn-primary btn-success">质量检查</a>
					</t:privilege>
      			...
      			<div class="span8">
      				<form class="text-right form-inline margin-buttom" action="linePipeInspectionList.do" method="post">
						<strong>隧道</strong>
			...
			<table class="table table-striped table-bordered table-condensed table-hover">
				 <thead><tr>
					<th width="5%">序号</th>
					<th width="20%">预埋管线名称</th>
					<th width="10%">检测时间</th>
					<th width="50%">质量描述</th>
					<th width="15%">操作
					<t:privilege res="预埋管线质量检测模块:新增">
						<a class="space btn btn-small btn-info" href="linePipeInspectionAdd.do?index=<s:property value="index"/>&tunnelId=<s:property value="tunnelId"/>&tunnelSectionId=<s:property value="parentTunnelSectionId"/>">新增</a>
					</t:privilege>
					</th>
				</tr></thead><tbody>
				<s:iterator value="inspections" status="vs">
					...
					<td>
					<t:privilege res="预埋管线质量检测模块:详情">
						<a class="btn btn-small btn-success" href="linePipeInspectionDetail.do?inspectionId=<s:property value="id"/>&index=<s:property value="index"/>&tunnelId=<s:property value="tunnelId"/>&tunnelSectionId=<s:property value="parentTunnelSectionId"/>">详情</a>
					</t:privilege>
					<t:privilege res="预埋管线质量检测模块:编辑">
						<a class="btn btn-small btn-primary" href="linePipeInspectionUpdate.do?inspectionId=<s:property value="id"/>&index=<s:property value="index"/>&tunnelId=<s:property value="tunnelId"/>&tunnelSectionId=<s:property value="parentTunnelSectionId"/>">编辑</a>
					</t:privilege>
					<t:privilege res="预埋管线质量检测模块:删除">
						<a class="delete btn  btn-small btn-danger" href="linePipeInspectionDelete.do?inspectionId=<s:property value="id"/>&index=<s:property value="index"/>&tunnelId=<s:property value="tunnelId"/>&tunnelSectionId=<s:property value="parentTunnelSectionId"/>">删除</a>
					</t:privilege>
					</td>
					</tr>
				</s:iterator></tbody>
