      ...
      <div class="span10"> 
      		<div class="row-fluid">
      			<div class="span4">
					...
					<a href="escapeList.do?tunnelId=<s:property value="tunnelId"/>&tunnelSectionId=<s:property value="parentTunnelSectionId"/>" class="btn btn-small  btn-primary btn-success">基本信息</a>
	    	  		</t:privilege>
