      		...
      		<form action="longitudinalFaultBatchDelete.do" id="form" method="post" onsubmit="return checkForm();">
				...
				<s:iterator value="longitudinalFaults" status="vs">
					...
					<t:privilege res="衬砌环纵缝错台检测模块:详情">
						<a class="btn btn-small btn-success" href="longitudinalFaultDetail.do?tunnelId=<s:property value="tunnelId"/>&tunnelSectionId=<s:property value="parentTunnelSectionId"/>&longitudinalFaultId=<s:property value="id"/>&liningRingConstructionId=<s:property value="parentLiningRingConstructionId"/>&index=<s:property value="index"/>">详情</a>
					</t:privilege>
					<t:privilege res="衬砌环纵缝错台检测模块:编辑">
						<a class="btn btn-small btn-primary" href="longitudinalFaultUpdate.do?tunnelId=<s:property value="tunnelId"/>&tunnelSectionId=<s:property value="parentTunnelSectionId"/>&longitudinalFaultId=<s:property value="id"/>&liningRingConstructionId=<s:property value="parentLiningRingConstructionId"/>&index=<s:property value="index"/>">编辑</a>
					</t:privilege>
					<t:privilege res="衬砌环纵缝错台检测模块:删除">
						<a class="delete btn  btn-small btn-danger" href="longitudinalFaultDelete.do?tunnelId=<s:property value="tunnelId"/>&tunnelSectionId=<s:property value="parentTunnelSectionId"/>&longitudinalFaultId=<s:property value="id"/>&liningRingConstructionId=<s:property value="parentLiningRingConstructionId"/>&index=<s:property value="index"/>">删除</a>
					</t:privilege>
					</td>
					</tr>
				</s:iterator></tbody>
