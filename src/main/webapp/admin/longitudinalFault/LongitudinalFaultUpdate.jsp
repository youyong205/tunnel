  ...
  <div class="container-fluid background-body" >
    <div class="row-fluid">
      ...
      <div class="span10">
			...
			<form action="longitudinalFaultUpdateSubmit.do" id="form" method="post" >
				<table  class="table table-striped table-bordered table-condensed">
					...
					<tr>
						...
						<td colspan='3'><textarea type="text" rows="5" cols="40"  name="longitudinalFault.des" class="{maxlength:512}"><s:property value="longitudinalFault.des"/></textarea></td>
					</tr>
					<tr>
