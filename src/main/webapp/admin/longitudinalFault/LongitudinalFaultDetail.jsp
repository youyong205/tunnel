				...
				<table  class="table table-striped table-bordered table-condensed">
					...
					<tr>
						...
						<div id="datetimepicker1" class="input-append date">
				            <input readonly name="longitudinalFault.date"  placeholder="检测时间"  class="{required:true,date:true}"
						...
						<td><input readonly type="text" name="longitudinalFault.value" class="{required:true,number:true}" value="<s:property value="longitudinalFault.value"/>"/></td>
					</tr>
					<tr>
