  ...
  <div class="container-fluid">
    <div class="row-fluid">
      ...
      <div class="span10">
			...
			<form action="longitudinalOpenAddSubmit.do" id="form" method="post">
				<table  class="table table-striped table-bordered table-condensed">
					...
					<tr>
						...
						<td><input type="text" name="longitudinalOpen.value" class="{required:true,number:true}"/></td>
					</tr>
					<tr>
						<td style="text-align:right;"><strong class="text-success">纵缝张开位置</strong></td>
						<td>
							<select name="longitudinalOpen.type">
						...
						<td>
							<select name="longitudinalOpen.serious">
					...
					<tr>
						...
						<td><textarea type="text" rows="5" cols="40"  name="longitudinalOpen.des" class="{maxlength:512}"></textarea></td>
					</tr>
					<tr>
