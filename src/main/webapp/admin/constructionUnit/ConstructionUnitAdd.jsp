...
<body>
  ...
  <div class="container-fluid background-body" >
    <div class="row-fluid">
      ...
      <div class="span10">
			<form action="constructionUnitAddSubmit.do" id="form" method="post">
				<table  class="table table-striped table-bordered table-condensed">
					<tr>	
						<th colspan='2'><h4 class="text-info text-center">新增施工单位信息</h4></th>
						<input type="hidden" name="index" value="<s:property value="index"/>"/>
					</tr>
					<tr>
						<td width="20%" style="text-align:right;"><strong class="text-success">名称</strong></td>
						<td><input type="text" size="60" name="constructionUnit.name" class="{required:true,maxlength:128}"/></td>
					</tr>
					<tr>
						<td width="20%" style="text-align:right;"><strong class="text-success">类型</strong></td>
						<td><input type="text" size="60" name="constructionUnit.type" class="{required:true,maxlength:64}"/></td>
					</tr>
					<tr>
						<td width="20%" style="text-align:right;"><strong class="text-success">地址</strong></td>
						<td><input type="text" size="60" name="constructionUnit.address" class="{required:true,maxlength:128}"/></td>
					</tr>
					<tr>
						<td width="20%" style="text-align:right;"><strong class="text-success">施工人员</strong></td>
						<td><input type="text" size="60" name="constructionUnit.workers" class="{required:true,maxlength:128}"/></td>
					</tr>
					<tr>
