  ...
  <div class="container-fluid">
    <div class="row-fluid">
      ...
      <div class="span10">
			...
			<form action="girthFaultUpdateSubmit.do" id="form" method="post">
				<table  class="table table-striped table-bordered table-condensed">
					<tr>	
						...
						<input type="hidden" name="girthFault.id" value="<s:property value="girthFault.id"/>" />
					</tr>
					<tr>
					...
					<tr>
						...
						<div id="datetimepicker1" class="input-append date">
				            <input name="girthFault.date"  value="<s:date name="girthFault.date" format="yyyy-MM-dd"/>"  class="{required:true,date:true}"
					...
					<tr>
						...
						<td colspan='3'><textarea type="text" rows="5" cols="40"  name="girthFault.des" class="{maxlength:512}"><s:property value="girthFault.des"/></textarea></td>
					</tr>
					<tr>
