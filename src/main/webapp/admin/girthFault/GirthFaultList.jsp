    ...
    <div class="row-fluid">
      ...
      <div class="span10"> 
     		<%@include file="./../MeasuringHeader.jsp"%>
      		<div class="row-fluid">
      			<div class="span12">
      				<form class="text-right form-inline margin-buttom" action="girthFaultList.do" method="post">
						<strong>选择隧道</strong>
      		...
      		<form action="girthFaultBatchDelete.do" id="form" method="post" onsubmit="return checkForm();">
				...
				<table class="table table-striped table-bordered table-condensed table-hover">
				 <thead><tr>
					...
					<t:privilege res="衬砌环环缝错台检测模块:新增">
						...
						<a class="btn btn-small btn-info" href="girthFaultBatchAdd.do?tunnelId=<s:property value="tunnelId"/>&tunnelSectionId=<s:property value="parentTunnelSectionId"/>&liningRingConstructionId=<s:property value="liningRingConstructionId"/>&index=<s:property value="index"/>" >导入</a>
					</t:privilege>
				...
				<s:iterator value="girthFaults" status="vs">
					<tr>
