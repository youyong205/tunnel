  ...
  <div class="container-fluid">
    <div class="row-fluid">
      ...
      <div class="span10">
			...
			<form action="girthFaultAddSubmit.do" id="form" method="post">
				<table  class="table table-striped table-bordered table-condensed">
					...
					<tr>
						...
						<div id="datetimepicker1" class="input-append date">
				            <input name="girthFault.date"  placeholder="检测时间"  class="{required:true,date:true}"
					...
					<tr>
						...
						<td><input type="text" name="girthFault.measuringPoing" class="{required:true,maxlength:64}"/></td>
					...
					<tr>
						...
						<td colspan='3'><textarea type="text" rows="5" cols="60"  name="girthFault.des" class="{maxlength:512}"></textarea></td>
					</tr>
					<tr>
