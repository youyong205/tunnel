  ...
  <div class="container-fluid background-body" >
    <div class="row-fluid">
      ...
      <div class="span10">
			...
			<form action="cracksUpdateSubmit.do" id="form" method="post" >
				<table  class="table table-striped table-bordered table-condensed">
					<tr>	
						...
						<input type="hidden" name="cracks.id" value="<s:property value="cracks.id"/>" />
					</tr>
					<tr>
					...
					<tr>
						...
						<td><input type="text" name="cracks.type"  value='<s:property value="cracks.type"/>' class="{required:true,maxlength:64}"/></td>
					</tr>
					<tr>
						<td style="text-align:right;"><strong class="text-success">裂缝条数</strong></td>
						<td><input type="text" name="cracks.number"  value='<s:property value="cracks.number"/>' class="{required:true,number:true}"/></td>
						<td style="text-align:right;"><strong class="text-success">长度(mm)</strong></td>
						<td><input type="text" name="cracks.length"  value='<s:property value="cracks.length"/>' class="{required:true,number:true}"/></td>
					</tr>
					<tr>
						<td style="text-align:right;"><strong class="text-success">宽度(mm)</strong></td>
						<td><input type="text" name="cracks.width"  value='<s:property value="cracks.width"/>' class="{required:true,number:true}"/></td>
						<td style="text-align:right;"><strong class="text-success">深度(mm)</strong></td>
						<td><input type="text" name="cracks.depth"  value='<s:property value="cracks.depth"/>' class="{required:true,number:true}"/></td>
				
					</tr>
					<tr>
						<td style="text-align:right;"><strong class="text-success">中心点环向角度(°)</strong></td>
						<td><input type="text" name="cracks.angle"  value='<s:property value="cracks.angle"/>' class="{required:true,number:true}"/></td>
