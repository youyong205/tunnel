      ...
      <div class="span10">
				<table  class="table table-striped table-bordered table-condensed">
					...
					<tr>
						...
						<td><input type="text" name="contactChannel.soilOrder" readonly  value="<s:property value="contactChannel.soilOrder"/>" class="{required:true}"/></td>
					</tr>
					<tr>
						<td width="20%" style="text-align:right;"><strong class="text-success">联络通道编号</strong></td>
						<td width="30%"><input type="text" name="contactChannel.name"  readonly  value="<s:property value="contactChannel.name"/>" class="{required:true,maxlength:64}"/></td>
						<td width="15%" style="text-align:right;"><strong class="text-success">联络通道类型</strong></td>
						<td width="35%" ><input type="text" name="contactChannel.type" readonly  value="<s:property value="contactChannel.type"/>"  class="{required:true,maxlength:64}"/></td>
					</tr>
					<tr>
						<td style="text-align:right;"><strong class="text-success">上行线隧道里程(m)</strong></td>
						<td><input type="text" name="contactChannel.upLine"  readonly  value="<s:property value="contactChannel.upLine"/>" class="{required:true,number:true}"/></td>
						<td style="text-align:right;"><strong class="text-success">上行线隧道中心标高(m)</strong></td>
						<td><input type="text" name="contactChannel.upCenter"  readonly  value="<s:property value="contactChannel.upCenter"/>" class="{required:true,number:true}"/></td>
					</tr>
					<tr>
						<td style="text-align:right;"><strong class="text-success">下行线隧道里程(m)</strong></td>
						<td><input type="text" name="contactChannel.downLine"  readonly  value="<s:property value="contactChannel.downLine"/>" class="{required:true,number:true}"/></td>
						<td style="text-align:right;"><strong class="text-success">下行线隧道中心标高(m)</strong></td>
						<td><input type="text" name="contactChannel.downCenter" readonly   value="<s:property value="contactChannel.downCenter"/>" class="{required:true,number:true}"/></td>
					</tr>
					<tr>
