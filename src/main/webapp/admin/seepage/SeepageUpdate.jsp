  ...
  <div class="container-fluid">
    <div class="row-fluid">
      ...
      <div class="span10">
			...
			<form action="seepageUpdateSubmit.do" id="form" method="post" >
				<table  class="table table-striped table-bordered table-condensed">
					<tr>	
						...
						<input type="hidden" name="seepage.id" value="<s:property value="seepage.id"/>" />
					</tr>
					<tr>
					...
					<tr>
						...
						<td><input type="text" name="seepage.shape" value='<s:property value="seepage.shape"/>' class="{required:true,maxlength:64}"/></td>
					</tr>
					<tr>
						<td style="text-align:right;"><strong class="text-success">尺寸</strong></td>
						<td><input type="text" name="seepage.size" value='<s:property value="seepage.size"/>'  class="{required:true,number:true}"/></td>
						<td style="text-align:right;"><strong class="text-success">起始环向角度(°)</strong></td>
						<td><input type="text" name="seepage.startAngle"  value='<s:property value="seepage.startAngle"/>' class="{required:true,number:true}"/></td>
					</tr>
					<tr>
						<td style="text-align:right;"><strong class="text-success">终止环向角度(°)</strong></td>
						<td><input type="text" name="seepage.endAngle" value='<s:property value="seepage.endAngle"/>'  class="{required:true,number:true}"/></td>
					...
					<tr>
						...
						<td colspan='3'><textarea type="text" rows="5" cols="40"  name="seepage.des" class="{maxlength:512}"><s:property value="seepage.des"/></textarea></td>
					</tr>
					<tr>
