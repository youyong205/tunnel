      ...
      <div class="span10"> 
      		<div class="row-fluid">
      			<div class="span4">
					...
					<a href="linePipeList.do?tunnelId=<s:property value="tunnelId"/>&tunnelSectionId=<s:property value="parentTunnelSectionId"/>" class="btn btn-small  btn-primary btn-success">基本信息</a>
	    	  		</t:privilege>
					...
					<t:privilege res="预埋管线养护记录模块:详情">
	      			<a href="linePipeCuringList.do?tunnelId=<s:property value="tunnelId"/>&tunnelSectionId=<s:property value="parentTunnelSectionId"/>" class="btn btn-small  btn-primary btn-info">养护记录</a>
      				</t:privilege>
      			</div>
      			<div class="span8">
