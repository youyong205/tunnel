			...
			<form action="linePipeUpdateSubmit.do" id="form" method="post"  enctype="multipart/form-data">
				<table  class="table table-striped table-bordered table-condensed">
					...
					<tr>
						...
						<td style="text-align:right;"><strong class="text-success">预埋管线简介</strong></td>
						<td><textarea type="text" rows="5" cols="60"  name="linePipe.des" class="{maxlength:512}"><s:property value="linePipe.des"/></textarea></td>
					</tr>
					</table>
