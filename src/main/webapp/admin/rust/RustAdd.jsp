  ...
  <div class="container-fluid">
    <div class="row-fluid">
      ...
      <div class="span10">
			...
			<form action="rustAddSubmit.do" id="form" method="post">
				<table  class="table table-striped table-bordered table-condensed">
					...
					<tr>
						...
						<td><input type="text" name="rust.shape" class="{required:true,maxlength:64}"/></td>
					</tr>
					<tr>
						<td style="text-align:right;"><strong class="text-success">锈蚀面积(m㎡)</strong></td>
						<td><input type="text" name="rust.area" class="{required:true,number:true}"/></td>
						<td style="text-align:right;"><strong class="text-success">起始环向角度(°)</strong></td>
						<td><input type="text" name="rust.startAngle" class="{required:true,number:true}"/></td>
					</tr>
					<tr>
