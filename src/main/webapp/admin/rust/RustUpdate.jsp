  ...
  <div class="container-fluid">
    <div class="row-fluid">
      ...
      <div class="span10">
			...
			<form action="rustUpdateSubmit.do" id="form" method="post" >
				<table  class="table table-striped table-bordered table-condensed">
					<tr>	
						...
						<input type="hidden" name="rust.id" value="<s:property value="rust.id"/>" />
					</tr>
					<tr>
					...
					<tr>
						...
						<div id="datetimepicker1" class="input-append date">
				            <input name="rust.date"  placeholder="检测时间"  class="{required:true,date:true}"
						...
						<td><input type="text" name="rust.shape" value='<s:property value="rust.shape"/>' class="{required:true,maxlength:64}"/></td>
					</tr>
					<tr>
						<td style="text-align:right;"><strong class="text-success">锈蚀面积(m㎡)</strong></td>
						<td><input type="text" name="rust.area" value='<s:property value="rust.area"/>' class="{required:true,number:true}"/></td>
						<td style="text-align:right;"><strong class="text-success">起始环向角度(°)</strong></td>
						<td><input type="text" name="rust.startAngle" value='<s:property value="rust.startAngle"/>' class="{required:true,number:true}"/></td>
					</tr>
					<tr>
						<td style="text-align:right;"><strong class="text-success">终止环向角度(°)</strong></td>
						<td><input type="text" name="rust.endAngle" value='<s:property value="rust.endAngle"/>' class="{required:true,number:true}"/></td>
						<td style="text-align:right;"><strong class="text-success">简介</strong></td>
						<td><textarea type="text" rows="5" cols="60"  name="rust.des" class="{maxlength:512}"><s:property value="rust.des"/></textarea></td>
					</tr>
					<tr>
