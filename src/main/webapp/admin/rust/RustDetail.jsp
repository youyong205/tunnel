				...
				<table  class="table table-striped table-bordered table-condensed">
					...
					<tr>
						...
						<div id="datetimepicker1" class="input-append date">
				            <input readonly name="rust.date"  value="<s:date name="rust.date" format="yyyy-MM-dd"/>"  class="{required:true,date:true}"
					...
					<tr>
						...
						<td><input readonly type="text" name="rust.measuringPoing"  value="<s:property value="rust.measuringPoing"/>"  class="{required:true,maxlength:64}"/></td>
						<td style="text-align:right;"><strong class="text-success">变形值</strong></td>
						<td><input readonly type="text" name="rust.value" value="<s:property value="rust.value"/>" class="{required:true,number:true}"/></td>
					</tr>
					<tr>
						<td style="text-align:right;"><strong class="text-success">备注信息</strong></td>
						<td colspan='3'><textarea readonly type="text" rows="5" cols="60"  name="rust.des" class="{maxlength:512}"><s:property value="rust.des"/></textarea></td>
					</tr>
					</table>
			</form>
      </div>
