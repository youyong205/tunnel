			...
			<form action="liningRingDeformationUpdateSubmit.do" id="form" method="post">
				<table  class="table table-striped table-bordered table-condensed">
					...
					<tr>
						...
						<td colspan='3'><textarea type="text" rows="5" cols="40"  name="liningRingDeformation.des" class="{maxlength:512}"><s:property value="liningRingDeformation.des"/></textarea></td>
					</tr>
					<tr>
