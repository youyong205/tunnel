     		...
     		<%@include file="./../MeasuringHeader.jsp"%>
				<table  class="table table-striped table-bordered table-condensed">
					<tr>	
						...
						<input readonly type="hidden" name="liningRingDeformation.id" value="<s:property value="liningRingDeformation.id"/>" />
					</tr>
					<tr>
					...
					<tr>
						...
						<div id="datetimepicker1" class="input-append date">
				            <input readonly name="liningRingDeformation.date"  value="<s:date name="liningRingDeformation.date" format="yyyy-MM-dd"/>"  class="{required:true,date:true}"
					...
					<tr>
						...
						<td><input readonly type="text" name="liningRingDeformation.measuringPoing"  value="<s:property value="liningRingDeformation.measuringPoing"/>"  class="{required:true,maxlength:64}"/></td>
					...
					<tr>
						...
						<td colspan='3'><textarea readonly type="text" rows="5" cols="60"  name="liningRingDeformation.des" class="{maxlength:512}"><s:property value="liningRingDeformation.des"/></textarea></td>
					</tr>
					</table>
			</form>
      </div>
