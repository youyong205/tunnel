      		...
      		<div class="row-fluid">
      			<div class="span4">
					...
					<t:privilege res="设备养护记录模块:详情">
	      				<a href="facilityCuringList.do?tunnelId=<s:property value="tunnelId"/>&tunnelSectionId=<s:property value="parentTunnelSectionId"/>" class="btn btn-small  btn-primary btn-success">养护记录</a>
      				</t:privilege>
      			</div>
      			<div class="span8">
      				<form class="text-right form-inline margin-buttom" action="facilityCuringList.do" method="post">
						<strong>隧道</strong>
			...
			<table class="table table-striped table-bordered table-condensed table-hover">
				 <thead><tr>
					...
					<t:privilege res="设备质量检测模块:新增">
						<a class="space btn btn-small btn-info" href="facilityCuringAdd.do?index=<s:property value="index"/>&tunnelId=<s:property value="tunnelId"/>&tunnelSectionId=<s:property value="parentTunnelSectionId"/>">新增</a>
					</t:privilege>
					</th>
				</tr></thead><tbody>
				<s:iterator value="curings" status="vs">
					...
					<td>
					<t:privilege res="设备质量检测模块:详情">
						<a class="btn btn-small btn-success" href="facilityCuringDetail.do?curingId=<s:property value="id"/>&index=<s:property value="index"/>&tunnelId=<s:property value="tunnelId"/>&tunnelSectionId=<s:property value="parentTunnelSectionId"/>">详情</a>
					</t:privilege>
					<t:privilege res="设备质量检测模块:编辑">
						<a class="btn btn-small btn-primary" href="facilityCuringUpdate.do?curingId=<s:property value="id"/>&index=<s:property value="index"/>&tunnelId=<s:property value="tunnelId"/>&tunnelSectionId=<s:property value="parentTunnelSectionId"/>">编辑</a>
					</t:privilege>
					<t:privilege res="设备质量检测模块:删除">
						<a class="delete btn  btn-small btn-danger" href="facilityCuringDelete.do?curingId=<s:property value="id"/>&index=<s:property value="index"/>&tunnelId=<s:property value="tunnelId"/>&tunnelSectionId=<s:property value="parentTunnelSectionId"/>">删除</a>
					</t:privilege>
					</td>
					</tr>
				</s:iterator></tbody>
