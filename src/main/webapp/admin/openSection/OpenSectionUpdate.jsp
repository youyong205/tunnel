      ...
      <div class="span10">
			...
			<table  class="table table-striped table-bordered table-condensed">
					...
					<tr>
						...
						<td ><input type="text" name="openSection.envelope"  value="<s:property value="openSection.envelope"/>"  class="{required:true,maxlength:64}"/></td>
					</tr>
					<tr>
						<td width="20%" style="text-align:right;"><strong class="text-success">敞开段编号</strong></td>
						<td width="30%"><input type="text" name="openSection.name"  value="<s:property value="openSection.name"/>" class="{required:true,maxlength:64}"/></td>
						<td width="15%" style="text-align:right;"><strong class="text-success">敞开段类型</strong></td>
						<td width="35%" ><input type="text" name="openSection.type" value="<s:property value="openSection.type"/>"  class="{required:true,maxlength:64}"/></td>
					</tr>
					<tr>
						<td style="text-align:right;"><strong class="text-success">开始里程(m)</strong></td>
						<td><input type="text" name="openSection.startPosition"  value="<s:property value="openSection.startPosition"/>" class="{required:true,number:true}"/></td>
						<td style="text-align:right;"><strong class="text-success">结束里程(m)</strong></td>
						<td><input type="text" name="openSection.endPosition"  value="<s:property value="openSection.endPosition"/>" class="{required:true,number:true}"/></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td><input type="text" name="openSection.crestPileBottom"  value="<s:property value="openSection.crestPileBottom"/>" class="{required:true,number:true}"/></td>
						<td style="text-align:right;"><strong class="text-success">平台搅拌桩底标高(m)</strong></td>
						<td><input type="text" name="openSection.platformPileBottom"   value="<s:property value="openSection.endPosition"/>"  class="{required:true,number:true}"/></td>
					</tr>
					<tr>	
