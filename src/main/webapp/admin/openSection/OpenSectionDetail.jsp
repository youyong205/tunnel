    ...
    <div class="row-fluid">
      ...
      <div class="span10">
				<table  class="table table-striped table-bordered table-condensed">
					<tr>	
						<th colspan='4'><h4 class="text-info text-center">敞开段信息</h4></th>
					...
					<tr>
						...
						<td><input type="text" name="openSection.startFloor"  readonly  value="<s:property value="openSection.startFloor"/>"  class="{required:true,number:true}"/></td>
						<td style="text-align:right;"><strong class="text-success">起始路拱顶标高(m)</strong></td>
						<td><input type="text" name="openSection.startRoadDome"  readonly  value="<s:property value="openSection.startRoadDome"/>"  class="{required:true,number:true}"/></td>
					</tr>
					<tr>
						<td style="text-align:right;"><strong class="text-success">终止底板标高(m)</strong></td>
						<td><input type="text" name="openSection.endFloor"  readonly  value="<s:property value="openSection.endFloor"/>"  class="{required:true,number:true}"/></td>
						<td style="text-align:right;"><strong class="text-success">终止路拱顶标高(m)</strong></td>
						<td><input type="text" name="openSection.endRoadDome"  readonly  value="<s:property value="openSection.endRoadDome"/>"  class="{required:true,number:true}"/></td>
					</tr>
					<tr>
