...
<table  class="table table-striped table-bordered table-condensed">
	...
	<tr>
		...
		<div id="datetimepicker1" class="input-append date">
            <input name="schedule.startTimeStr" readonly value="<s:property value="schedule.startTimeStr"/>"  class="{required:true,date:true}"
		...
		<td><div id="datetimepicker2" class="input-append date">
            <input name="schedule.endTimeStr"  readonly  value="<s:property value="schedule.endTimeStr"/>" class="{required:true,date:true}"
               data-format="yyyy-MM-dd hh:mm" type="text"></input> <span class="add-on"> <i
               data-time-icon="icon-time" data-date-icon="icon-calendar"> </i>
            </span>
         </div></td>
	...
	<tr>
		...
		<td colspan='3'><textarea type="text" readonly rows="5" cols="80"  name="schedule.des" class="{maxlength:512}"><s:property value="schedule.des"/></textarea></td>
	</tr>
</table>
