    ...
    <div class="row-fluid">
      ...
      <div class="span10"> 
     		<%@include file="./../MeasuringHeader.jsp"%>
      		<div class="row-fluid">
      			<div class="span12">
      				<form class="text-right form-inline margin-buttom" action="settlementList.do" method="post">
						<strong>选择隧道</strong>
      		...
      		<form action="settlementBatchDelete.do" id="form" method="post" onsubmit="return checkForm();">
				...
				<table class="table table-striped table-bordered table-condensed table-hover">
				 <thead><tr>
					...
					<t:privilege res="衬砌环横断面变形检测模块:新增">
						...
						<a class="btn btn-small btn-info" href="settlementBatchAdd.do?tunnelId=<s:property value="tunnelId"/>&tunnelSectionId=<s:property value="parentTunnelSectionId"/>&liningRingConstructionId=<s:property value="liningRingConstructionId"/>&index=<s:property value="index"/>" >导入</a>
					</t:privilege>
				...
				<s:iterator value="settlements" status="vs">
					<tr>
