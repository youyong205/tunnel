...
<script type="text/javascript">
	$(document).ready(function() {
		$('#liningRingConstructionCuringList').addClass('active');
    ...
    <div class="row-fluid">
      ...
      <div class="span10"> 
      		<div class="row-fluid">
      			...
      			<div class="span8">
      				<form class="text-right form-inline margin-buttom" action="liningRingConstructionCuringList.do" method="post">
						<strong>选择隧道</strong>
			...
			<table class="table table-striped table-bordered table-condensed table-hover">
				 <thead><tr>
					<th width="5%">序号</th>
					<th width="15%">衬砌环名称</th>
					<th width="7%">养护时间</th>
					<th width="13%">相关附件</th>
					<th width="45%">养护措施</th>
					<th width="15%">操作
					<t:privilege res="衬砌环质量检测模块:新增">
						<a class="space btn btn-small btn-info" href="liningRingConstructionCuringAdd.do?index=<s:property value="index"/>&tunnelId=<s:property value="tunnelId"/>&tunnelSectionId=<s:property value="parentTunnelSectionId"/>">新增</a>
					</t:privilege>
					</th>
				</tr></thead><tbody>
				<s:iterator value="curings" status="vs">
					...
					<t:privilege res="衬砌环质量检测模块:详情">
						<a class="btn btn-small btn-success" href="liningRingConstructionCuringDetail.do?curingId=<s:property value="id"/>&index=<s:property value="index"/>&tunnelId=<s:property value="tunnelId"/>&tunnelSectionId=<s:property value="parentTunnelSectionId"/>">详情</a>
					</t:privilege>
					<t:privilege res="衬砌环质量检测模块:编辑">
						<a class="btn btn-small btn-primary" href="liningRingConstructionCuringUpdate.do?curingId=<s:property value="id"/>&index=<s:property value="index"/>&tunnelId=<s:property value="tunnelId"/>&tunnelSectionId=<s:property value="parentTunnelSectionId"/>">编辑</a>
					</t:privilege>
					<t:privilege res="衬砌环质量检测模块:删除">
						<a class="delete btn  btn-small btn-danger" href="liningRingConstructionCuringDelete.do?curingId=<s:property value="id"/>&index=<s:property value="index"/>&tunnelId=<s:property value="tunnelId"/>&tunnelSectionId=<s:property value="parentTunnelSectionId"/>">删除</a>
					</t:privilege>
					</td>
					</tr>
				</s:iterator></tbody>
