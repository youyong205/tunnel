      ...
      <div class="span10"> 
			<div class="row-fluid">
				<div class="span6">
					...
					<a href="workingWellList.do?tunnelId=<s:property value="tunnelId"/>" class="btn btn-small  btn-primary btn-info">基本信息</a>
	    	  		...
	    	  		<a href="workingWellInspectionList.do?tunnelId=<s:property value="tunnelId"/>" class="btn btn-small btn-primary btn-success">质量检查</a>
					</t:privilege>
      			...
      			</div><div class="span6"><form class="text-right form-inline margin-buttom" action="workingWellInspectionList.do" method="post">
			  隧道
			...
			<table class="table table-striped table-bordered table-condensed table-hover">
				 <thead><tr>
					...
					<th width="50%">质量描述</th>
					<th width="15%">操作
					<t:privilege res="工作井质量检测模块:新增">
						<a class="space btn btn-small btn-info" href="workingWellInspectionAdd.do?index=<s:property value="index"/>&tunnelId=<s:property value="tunnelId"/>" >新增</a>
					</t:privilege>
					</th>
				</tr></thead><tbody>
				<s:iterator value="inspections" status="vs">
					...
					<td>
					<t:privilege res="工作井质量检测模块:详情">
						<a class="btn btn-small btn-success" href="workingWellInspectionDetail.do?inspectionId=<s:property value="id"/>&index=<s:property value="index"/>&tunnelId=<s:property value="tunnelId"/>">详情</a>
					</t:privilege>
					<t:privilege res="工作井质量检测模块:编辑">
						<a class="btn btn-small btn-primary" href="workingWellInspectionUpdate.do?inspectionId=<s:property value="id"/>&index=<s:property value="index"/>&tunnelId=<s:property value="tunnelId"/>">编辑</a>
					</t:privilege>
					<t:privilege res="工作井质量检测模块:删除">
						<a class="delete btn  btn-small btn-danger" href="workingWellInspectionDelete.do?inspectionId=<s:property value="id"/>&index=<s:property value="index"/>&tunnelId=<s:property value="tunnelId"/>">删除</a>
					</t:privilege>
					</td>
					</tr>
				</s:iterator></tbody>
