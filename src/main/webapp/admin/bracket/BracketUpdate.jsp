...
<body>
  ...
  <div class="container-fluid">
    <div class="row-fluid">
      ...
      <div class="span10">
			<form action="bracketUpdateSubmit.do" id="form" method="post"  enctype="multipart/form-data">
				<table  class="table table-striped table-bordered table-condensed">
					<tr>	
						<th colspan='4'><h4 class="text-info text-center">编辑牛腿信息</h4></th>
					...
					<tr>
						...
						<td ><input type="text" size="40" name="bracket.name" value="<s:property value="bracket.name"/>"  class="{required:true,maxlength:64}"/></td>
						<td style="text-align:right;"><strong class="text-success">牛腿类型</strong></td>
						<td ><input type="text" size="40" name="bracket.type"  value="<s:property value="bracket.type"/>"  class="{required:true,maxlength:64}"/></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td><input type="text" size="40" name="bracket.concreteStrength" value="<s:property value="bracket.concreteStrength"/>"  class="{required:true,maxlength:64}"/></td>
						<td style="text-align:right;"><strong class="text-success">钢筋强度</strong></td>
						<td><input type="text" size="40" name="bracket.reinforcementStrength"  value="<s:property value="bracket.reinforcementStrength"/>"  class="{required:true,maxlength:64}"/></td>
					</tr>
					<tr>
						<td style="text-align:right;"><strong class="text-success">开始里程(m)</strong></td>
						<td><input type="text" name="bracket.startPosition"  value="<s:property value="bracket.startPosition"/>" class="{required:true,number:true}"/></td>
						<td style="text-align:right;"><strong class="text-success">结束里程(m)</strong></td>
						<td><input type="text" name="bracket.endPosition"  value="<s:property value="bracket.endPosition"/>"  class="{required:true,number:true}"/></td>
					</tr>
					<tr>
						...
						<td><textarea type="text" rows="5" cols="40"  name="bracket.des" class="{maxlength:512}"><s:property value="bracket.des"/></textarea></td>
					</tr>
					</table>
