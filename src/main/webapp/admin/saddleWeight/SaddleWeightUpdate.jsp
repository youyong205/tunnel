...
<body>
  ...
  <div class="container-fluid">
    <div class="row-fluid">
      ...
      <div class="span10">
			<form action="saddleWeightUpdateSubmit.do" id="form" method="post"  enctype="multipart/form-data">
				<table  class="table table-striped table-bordered table-condensed">
					...
					<tr>
						...
						<td ><input type="text" size="40" name="saddleWeight.name" value="<s:property value="saddleWeight.name"/>"  class="{required:true,maxlength:64}"/></td>
						<td style="text-align:right;"><strong class="text-success">压重块类型</strong></td>
						<td ><input type="text" size="40" name="saddleWeight.type"  value="<s:property value="saddleWeight.type"/>"  class="{required:true,maxlength:64}"/></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td><input type="text" size="40" name="saddleWeight.concreteStrength" value="<s:property value="saddleWeight.concreteStrength"/>"  class="{required:true,maxlength:64}"/></td>
						<td style="text-align:right;"><strong class="text-success">钢筋强度</strong></td>
						<td><input type="text" size="40" name="saddleWeight.reinforcementStrength"  value="<s:property value="saddleWeight.reinforcementStrength"/>"  class="{required:true,maxlength:64}"/></td>
					</tr>
					<tr>
						<td style="text-align:right;"><strong class="text-success">开始里程(m)</strong></td>
						<td><input type="text" name="saddleWeight.startPosition"  value="<s:property value="saddleWeight.startPosition"/>" class="{required:true,number:true}"/></td>
						<td style="text-align:right;"><strong class="text-success">结束里程(m)</strong></td>
						<td><input type="text" name="saddleWeight.endPosition"  value="<s:property value="saddleWeight.endPosition"/>"  class="{required:true,number:true}"/></td>
					</tr>
					<tr>
						...
						<td><textarea type="text" rows="5" cols="40"  name="saddleWeight.des" class="{maxlength:512}"><s:property value="saddleWeight.des"/></textarea></td>
					</tr>
					</table>
