...
<body>
  ...
  <div class="container-fluid">
    <div class="row-fluid">
      ...
      <div class="span10">
			<form action="saddleWeightAddSubmit.do" id="form" method="post" enctype="multipart/form-data">
				<table  class="table table-striped table-bordered table-condensed">
					<tr>	
						<th colspan='4'><h4 class="text-info text-center">新增压重块信息</h4></th>
					...
					<tr>
						...
						<td><input type="text" size="40" name="saddleWeight.name" class="{required:true,maxlength:64}"/></td>
						<td style="text-align:right;"><strong class="text-success">压重块类型</strong></td>
						<td><input type="text" size="40" name="saddleWeight.type" class="{required:true,maxlength:64}"/></td>
					</tr>
					<tr>
						<td style="text-align:right;"><strong class="text-success">混凝土强度</strong></td>
						<td><input type="text" size="40" name="saddleWeight.concreteStrength" class="{required:true,maxlength:64}"/></td>
						<td style="text-align:right;"><strong class="text-success">钢筋强度</strong></td>
						<td><input type="text" size="40" name="saddleWeight.reinforcementStrength" class="{required:true,maxlength:64}"/></td>
					</tr>
					<tr>
						<td style="text-align:right;"><strong class="text-success">线路类型</strong></td>
						<td colspan='3'>
							<select name="saddleWeight.lineType">
					...
					<tr>
						...
						<td><input type="text" name="saddleWeight.startPosition" class="{required:true,number:true}"/></td>
						<td style="text-align:right;"><strong class="text-success">结束里程(m)</strong></td>
						<td><input type="text" name="saddleWeight.endPosition" class="{required:true,number:true}"/></td>
					</tr>
					<tr>
						...
						<td><textarea type="text" rows="5" cols="60"  name="saddleWeight.des" class="{maxlength:512}"></textarea></td>
					</tr>
					</table>
