...
<body>
  ...
  <div class="container-fluid">
    <div class="row-fluid">
      ...
      <div class="span10">
			<form action="pumpingStationAddSubmit.do" id="form" method="post" enctype="multipart/form-data">
				<table  class="table table-striped table-bordered table-condensed">
					<tr>	
						<th colspan='4'><h4 class="text-info text-center">新增泵房信息</h4></th>
					...
					<tr>
						...
						<td><input type="text" size="40" name="pumpingStation.name" class="{required:true,maxlength:64}"/></td>
						<td style="text-align:right;"><strong class="text-success">泵房类型</strong></td>
						<td><input type="text" size="40" name="pumpingStation.type" class="{required:true,maxlength:64}"/></td>
					</tr>
					<tr>
						<td style="text-align:right;"><strong class="text-success">桩号里程</strong></td>
						<td><input type="text" size="40" name="pumpingStation.stakeMileage" class="{required:true,maxlength:64}"/></td>
						<td style="text-align:right;"><strong class="text-success">位置描述</strong></td>
						<td><input type="text" size="40" name="pumpingStation.position" class="{required:true,maxlength:64}"/></td>
					</tr>
					<tr>
						...
						<td><input type="text" size="40" name="pumpingStation.laneMileage" class="{required:true,number:true}"/></td>
					</tr>
					<tr>
						<td style="text-align:right;"><strong class="text-success">盾构中心线里程(m)</strong></td>
						<td><input type="text" size="40" name="pumpingStation.shieldMileage" class="{required:true,number:true}"/></td>
						<td style="text-align:right;"><strong class="text-success">+0.000对应绝对标高(m)</strong></td>
						<td><input type="text" size="40" name="pumpingStation.absolutEelevation" class="{required:true,number:true}"/></td>
					</tr>
					<tr>
						...
						<td style="text-align:right;"><strong class="text-success">泵房简介</strong></td>
						<td><textarea type="text" rows="5" cols="50"  name="pumpingStation.des" class="{maxlength:512}"></textarea></td>
					</tr>
					</table>
