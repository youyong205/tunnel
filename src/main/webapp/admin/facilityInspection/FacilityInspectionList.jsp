      ...
      <div class="span10"> 
      		<div class="row-fluid">
      			<div class="span4">
		      		<t:privilege res="设备模块:详情">
						<a href="facilityList.do?tunnelId=<s:property value="tunnelId"/>&tunnelSectionId=<s:property value="parentTunnelSectionId"/>" class="btn btn-small  btn-primary btn-info">基本信息</a>
	    	  		</t:privilege>
	    	  		<t:privilege res="设备质量检测模块:详情">
	    	  			<a href="facilityInspectionList.do?tunnelId=<s:property value="tunnelId"/>&tunnelSectionId=<s:property value="parentTunnelSectionId"/>" class="btn btn-small btn-primary btn-success">质量检查</a>
					</t:privilege>
      			...
      			<div class="span8">
      				<form class="text-right form-inline margin-buttom" action="facilityInspectionList.do" method="post">
						<strong>隧道</strong>
			...
			<table class="table table-striped table-bordered table-condensed table-hover">
				 <thead><tr>
					...
					<th width="50%">质量描述</th>
					<th width="15%">操作
					<t:privilege res="设备质量检测模块:新增">
						<a class="space btn btn-small btn-info" href="facilityInspectionAdd.do?index=<s:property value="index"/>&tunnelId=<s:property value="tunnelId"/>&tunnelSectionId=<s:property value="parentTunnelSectionId"/>">新增</a>
					</t:privilege>
					</th>
				</tr></thead><tbody>
				<s:iterator value="inspections" status="vs">
					...
					<td>
					<t:privilege res="设备质量检测模块:详情">
						<a class="btn btn-small btn-success" href="facilityInspectionDetail.do?inspectionId=<s:property value="id"/>&index=<s:property value="index"/>&tunnelId=<s:property value="tunnelId"/>&tunnelSectionId=<s:property value="parentTunnelSectionId"/>">详情</a>
					</t:privilege>
					<t:privilege res="设备质量检测模块:编辑">
						<a class="btn btn-small btn-primary" href="facilityInspectionUpdate.do?inspectionId=<s:property value="id"/>&index=<s:property value="index"/>&tunnelId=<s:property value="tunnelId"/>&tunnelSectionId=<s:property value="parentTunnelSectionId"/>">编辑</a>
					</t:privilege>
					<t:privilege res="设备质量检测模块:删除">
						<a class="delete btn  btn-small btn-danger" href="facilityInspectionDelete.do?inspectionId=<s:property value="id"/>&index=<s:property value="index"/>&tunnelId=<s:property value="tunnelId"/>&tunnelSectionId=<s:property value="parentTunnelSectionId"/>">删除</a>
					</t:privilege>
					</td>
					</tr>
				</s:iterator></tbody>
