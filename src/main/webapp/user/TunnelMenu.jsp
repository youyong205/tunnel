...
<div class="well sidebar-nav">
	<ul class="nav nav-list">
		<li id='baseInfo' class="nav-header"><a href="userTunnelList.do?tunnelId=<s:property value="tunnelId"/>&index=<s:property value="index"/>">隧道信息</a></li>
		...
		<li id="mailRecordList" class="nav-header"><a href="userMailRecordList.do?tunnelId=<s:property value="tunnelId"/>&index=<s:property value="index"/>">系统邮件</a></li>
	</ul>
</div>