		...
		<div class='span10'>
			<div class="row-fluid">
			    <div class="span6">
      			...
      			<div class="span6">
		      		<form class="text-right form-inline margin-buttom" action="userOpenSectionList.do" method="post">
					  隧道
				...
				<s:iterator value="openSections" status="vs">
					...
					<td>
						<t:privilege res="敞开段模块:详情">
							<a class="btn btn-small btn-success" href="userOpenSectionDetail.do?openSectionId=<s:property value="id"/>&index=<s:property value="index"/>&tunnelId=<s:property value="tunnelIndexId"/>">详情</a>
						</t:privilege>
						</td>
					</tr>
				</s:iterator></tbody>
