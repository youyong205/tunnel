	...
	<div class="row-fluid">
     ...
     <div class="row-fluid">
			    <div class="span6">
      			...
      			<div class="span6">
		      		<form class="text-right form-inline margin-buttom" action="userWorkingWellInspectionList.do" method="post">
			  隧道
			...
			<table class="table table-striped table-bordered table-condensed table-hover">
				...
				<s:iterator value="inspections" status="vs">
					...
					<td>
						<a class="btn btn-small btn-success" href="userWorkingWellInspectionDetail.do?inspectionId=<s:property value="id"/>&index=<s:property value="index"/>&tunnelId=<s:property value="tunnelId"/>">详情</a>
					</td>
					</tr>
				</s:iterator></tbody>
			</table>
