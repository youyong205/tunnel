     ...
     <div class="row-fluid">
			    <div class="span6">
					<a href="userContactChannelList.do?tunnelId=<s:property value="tunnelId"/>" class="btn btn-small  btn-primary btn-info">联络通道列表</a>
	    	  		<a href="userContactChannelInspectionList.do?tunnelId=<s:property value="tunnelId"/>" class="btn btn-small btn-primary btn-success" >质量检查</a>
      			...
      			<div class="span6">
		      		<form class="text-right form-inline margin-buttom" action="userContactChannelInspectionList.do" method="post">
			  隧道
			...
			<table class="table table-striped table-bordered table-condensed table-hover">
				...
				<s:iterator value="inspections" status="vs">
					...
					<td>
						<a class="btn btn-small btn-success" href="userContactChannelInspectionDetail.do?inspectionId=<s:property value="id"/>&index=<s:property value="index"/>&tunnelId=<s:property value="tunnelId"/>">详情</a>
					</td>
					</tr>
				</s:iterator></tbody>
			</table>
