  ...
  <div class="container">
	...
	<div class='row'>
		...
		<div class='span10'>
			<div class="row-fluid">
			    <div class="span6">
					<a href="userOpenSectionList.do?tunnelId=<s:property value="tunnelId"/>" class="btn btn-small  btn-primary btn-info">敞开段列表</a>
      				...
      				<a href="userOpenSectionCuringList.do?tunnelId=<s:property value="tunnelId"/>" class="btn btn-small  btn-primary btn-success ">养护记录</a>
      			</div>
				<div class="span6"><form class="text-right form-inline margin-buttom" action="userOpenSectionCuringList.do" method="post">
				  隧道
			...
			<table class="table table-striped table-bordered table-condensed table-hover">
				...
				<s:iterator value="curings" status="vs">
					...
					<t:privilege res="敞开段养护记录模块:详情">
						<a class="btn btn-small btn-success" href="userOpenSectionCuringDetail.do?curingId=<s:property value="id"/>&index=<s:property value="index"/>&tunnelId=<s:property value="tunnelId"/>">详情</a>
					</t:privilege>
					</td>
					</tr>
				</s:iterator></tbody>
