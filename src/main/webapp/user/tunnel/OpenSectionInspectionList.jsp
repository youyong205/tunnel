     ...
     <div class="row-fluid">
			    <div class="span6">
					<a href="userOpenSectionList.do?tunnelId=<s:property value="tunnelId"/>" class="btn btn-small  btn-primary btn-info">敞开段列表</a>
	    	  		<a href="userOpenSectionInspectionList.do?tunnelId=<s:property value="tunnelId"/>" class="btn btn-small btn-primary btn-success" >质量检查</a>
	      			<a href="userOpenSectionCuringList.do?tunnelId=<s:property value="tunnelId"/>" class="btn btn-small  btn-primary btn-info">养护记录</a>
      			</div>
      			<div class="span6">
		      		<form class="text-right form-inline margin-buttom" action="userOpenSectionInspectionList.do" method="post">
			  隧道
			...
			<table class="table table-striped table-bordered table-condensed table-hover">
				...
				<s:iterator value="inspections" status="vs">
					...
					<td>
						<a class="btn btn-small btn-success" href="userOpenSectionInspectionDetail.do?inspectionId=<s:property value="id"/>&index=<s:property value="index"/>&tunnelId=<s:property value="tunnelId"/>">详情</a>
					</td>
					</tr>
				</s:iterator></tbody>
			</table>
