  ...
  <div class="container">
	...
	<div class='row'>
		...
		<div class='span10'>
			<div class="row-fluid">
			    <div class="span6">
					<a href="userWorkingWellList.do?tunnelId=<s:property value="tunnelId"/>" class="btn btn-small  btn-primary btn-success">工作井列表</a>
      			...
      			<div class="span6">
		      		<form class="text-right form-inline margin-buttom" action="userWorkingWellList.do" method="post">
					  隧道
				...
				<s:iterator value="workingWells" status="vs">
					...
					<td>
						<t:privilege res="工作井模块:详情">
							<a class="btn btn-small btn-success" href="userWorkingWellDetail.do?workingWellId=<s:property value="id"/>&index=<s:property value="index"/>&tunnelId=<s:property value="tunnelIndexId"/>">详情</a>
						</t:privilege>
						</td>
					</tr>
				</s:iterator></tbody>
