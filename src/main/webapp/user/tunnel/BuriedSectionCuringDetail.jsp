  ...
  <div class="container">
	...
	<div>
		<ul class="breadcrumb">
			...
			<li class="active"><a href="userBuriedSectionCuringList.do?tunnelId=<s:property value="tunnelId"/>">养护记录</a><span class="divider">/</span></li>
			...
			<div class="row-fluid">
			    <div class="span12">
					<a href="userBuriedSectionList.do?tunnelId=<s:property value="tunnelId"/>" class="btn btn-small  btn-primary btn-info">联络通道列表</a>
      				...
      				<a href="userBuriedSectionCuringList.do?tunnelId=<s:property value="tunnelId"/>" class="btn btn-small  btn-primary btn-success ">养护记录</a>
      			</div>
			</div>
