  ...
  <div class="container">
	...
	<div class="row-fluid">
		...
		<div class='span10'>
			<div class="row-fluid">
			    <div class="span6">
					<a href="userBuriedSectionList.do?tunnelId=<s:property value="tunnelId"/>" class="btn btn-small  btn-primary btn-success">暗埋段列表</a>
      			...
      			<div class="span6">
		      		<form class="text-right form-inline margin-buttom" action="userBuriedSectionList.do" method="post">
					  隧道
				...
				<s:iterator value="buriedSections" status="vs">
					...
					<td>
						<t:privilege res="暗埋段模块:详情">
							<a class="btn btn-small btn-success" href="userBuriedSectionDetail.do?buriedSectionId=<s:property value="id"/>&index=<s:property value="index"/>&tunnelId=<s:property value="tunnelIndexId"/>">详情</a>
						</t:privilege>
						</td>
					</tr>
				</s:iterator></tbody>
