			...
			<table class="table table-striped table-bordered table-condensed table-hover">
				...
				<s:iterator value="curings" status="vs">
					...
					<t:privilege res="烟道板养护记录模块:详情">
						<a class="btn btn-small btn-success" href="userFlueSheetCuringDetail.do?curingId=<s:property value="id"/>&index=<s:property value="index"/>&tunnelId=<s:property value="tunnelId"/>">详情</a>
					</t:privilege>
					</td>
					</tr>
				</s:iterator></tbody>
