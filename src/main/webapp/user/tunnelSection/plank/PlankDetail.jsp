  ...
  <div class="container">
	...
	<div class="row-fluid">
		...
		<div class='span10'>
			<div class="row-fluid">
			    <div class="span12">
					<a href="userPlankList.do?tunnelId=<s:property value="tunnelId"/>&tunnelSectionId=<s:property value="tunnelSectionId"/>" class="btn btn-small  btn-primary btn-success">车道板列表</a>
    	  			<a href="userPlankInspectionList.do?tunnelId=<s:property value="tunnelId"/>&tunnelSectionId=<s:property value="tunnelSectionId"/>" class="btn btn-small btn-primary btn-info">质量检查</a>
      				<a href="userPlankCuringList.do?tunnelId=<s:property value="tunnelId"/>&tunnelSectionId=<s:property value="tunnelSectionId"/>" class="btn btn-small  btn-primary btn-info">养护记录</a>
      			</div>
      		</div>
      			<table  class="table table-striped table-bordered table-condensed">
					<tr>	
						<th colspan='4'><h4 class="text-info text-center">车道板信息详情</h4></th>
					</tr>
					<tr>
					...
					<tr>
						...
						<td ><input readonly type="text" name="plank.name" value="<s:property value="plank.name"/>"  class="{required:true,maxlength:64}"/></td>
						<td style="text-align:right;"><strong class="text-success">车道板类型</strong></td>
						<td ><input readonly type="text" name="plank.type"  value="<s:property value="plank.type"/>"  class="{required:true,maxlength:64}"/></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td><textarea readonly type="text" rows="5" cols="30"  name="plank.des" class="{maxlength:512}"><s:property value="plank.des"/></textarea></td>
					</tr>
					</table>
