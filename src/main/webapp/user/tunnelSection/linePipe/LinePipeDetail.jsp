			...
			<div class="row-fluid">
			    <div class="span12">
      			...
      			<table  class="table table-striped table-bordered table-condensed">
					<tr>	
						<th colspan='4'><h4 class="text-info text-center">预埋管线信息详情</h4></th>
					</tr>
					<tr>
					...
					<tr>
						...
						<td ><input readonly type="text" name="linePipe.name" value="<s:property value="linePipe.name"/>"  class="{required:true,maxlength:64}"/></td>
						<td style="text-align:right;"><strong class="text-success">预埋管线类型</strong></td>
						<td ><input readonly type="text" name="linePipe.type"  value="<s:property value="linePipe.type"/>"  class="{required:true,maxlength:64}"/></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td><input readonly type="text" name="linePipe.startPosition"  value="<s:property value="linePipe.startPosition"/>" class="{required:true,number:true}"/></td>
						<td style="text-align:right;"><strong class="text-success">结束里程(m)</strong></td>
						<td><input readonly type="text" name="linePipe.endPosition"  value="<s:property value="linePipe.endPosition"/>"  class="{required:true,number:true}"/></td>
					</tr>
					<tr>
						...
						<td><textarea readonly type="text" rows="5" cols="30"  name="linePipe.des" class="{maxlength:512}"><s:property value="linePipe.des"/></textarea></td>
					</tr>
					</table>
