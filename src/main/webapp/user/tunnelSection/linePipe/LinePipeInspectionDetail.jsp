...
<script type="text/javascript">
	$(document).ready(function() {
		...
		$('#lineType').val('<s:property value="linePipe.lineType"/>');
	});
</script>
</head>
<body>
  <div class="container">
	...
	<div>
		<ul class="breadcrumb">
			...
			<li><a href="userLinePipeInspectionList.do?tunnelId=<s:property value="tunnelId"/>&tunnelSectionId=<s:property value="tunnelSectionId"/>">质量检查</a><span class="divider">/</span></li>
			...
			<div class="row-fluid">
			    <div class="span12">
					<a href="userLinePipeList.do?tunnelId=<s:property value="tunnelId"/>&tunnelSectionId=<s:property value="tunnelSectionId"/>" class="btn btn-small  btn-primary btn-info">预埋管线列表</a>
    	  			<a href="userLinePipeInspectionList.do?tunnelId=<s:property value="tunnelId"/>&tunnelSectionId=<s:property value="tunnelSectionId"/>" class="btn btn-small btn-primary btn-success ">质量检查</a>
      				<a href="userLinePipeInspectionList.do?tunnelId=<s:property value="tunnelId"/>&tunnelSectionId=<s:property value="tunnelSectionId"/>" class="btn btn-small  btn-primary  btn-info">养护记录</a>
      			</div>
			</div>
