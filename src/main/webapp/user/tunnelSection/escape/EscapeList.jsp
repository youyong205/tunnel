		...
		<div class='span10'>
			...
			<table class="table table-striped table-bordered table-condensed table-hover">
				...
				<s:iterator value="escapes" status="vs">
					...
					<td>
						<a class="btn btn-small btn-success" href="userEscapeDetail.do?tunnelId=<s:property value="tunnelId"/>&tunnelSectionId=<s:property value="parentTunnelSectionId"/>&escapeId=<s:property value="id"/>&index=<s:property value="index"/>">详情</a>
					</td>
					</tr>
				</s:iterator></tbody>
			</table>
