...
<script type="text/javascript">
	$(document).ready(function() {
		...
		$('#lineType').val('<s:property value="escape.lineType"/>');
	});
</script>
</head>
<body>
  <div class="container">
	...
	<div>
		<ul class="breadcrumb">
			...
			<li><a href="userEscapeInspectionList.do?tunnelId=<s:property value="tunnelId"/>&tunnelSectionId=<s:property value="tunnelSectionId"/>">质量检查</a><span class="divider">/</span></li>
			...
			<div class="row-fluid">
			    <div class="span12">
					<a href="userEscapeList.do?tunnelId=<s:property value="tunnelId"/>&tunnelSectionId=<s:property value="tunnelSectionId"/>" class="btn btn-small  btn-primary btn-info">逃生楼梯列表</a>
      				...
      				<a href="userEscapeInspectionList.do?tunnelId=<s:property value="tunnelId"/>&tunnelSectionId=<s:property value="tunnelSectionId"/>" class="btn btn-small  btn-primary  btn-info">养护记录</a>
      			</div>
			</div>
