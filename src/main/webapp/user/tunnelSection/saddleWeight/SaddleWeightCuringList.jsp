			...
			<div class="row-fluid">
			    <div class="span4">
					<a href="userSaddleWeightList.do?tunnelId=<s:property value="tunnelId"/>&tunnelSectionId=<s:property value="tunnelSectionId"/>" class="btn btn-small  btn-primary btn-info">压重块列表</a>
      				...
      				<a href="userSaddleWeightCuringList.do?tunnelId=<s:property value="tunnelId"/>&tunnelSectionId=<s:property value="tunnelSectionId"/>" class="btn btn-small  btn-primary btn-success ">养护记录</a>
      			</div>
				<div class="span8">
			...
			<table class="table table-striped table-bordered table-condensed table-hover">
				...
				<s:iterator value="curings" status="vs">
					...
					<t:privilege res="压重块养护记录模块:详情">
						<a class="btn btn-small btn-success" href="userSaddleWeightCuringDetail.do?curingId=<s:property value="id"/>&index=<s:property value="index"/>&tunnelId=<s:property value="tunnelId"/>">详情</a>
					</t:privilege>
					</td>
					</tr>
				</s:iterator></tbody>
