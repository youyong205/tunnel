     ...
     <div class="row-fluid">
			...
			<table class="table table-striped table-bordered table-condensed table-hover">
				...
				<s:iterator value="inspections" status="vs">
					...
					<td>
						<a class="btn btn-small btn-success" href="userFacilityInspectionDetail.do?inspectionId=<s:property value="id"/>&index=<s:property value="index"/>&tunnelId=<s:property value="tunnelId"/>">详情</a>
					</td>
					</tr>
				</s:iterator></tbody>
			</table>
