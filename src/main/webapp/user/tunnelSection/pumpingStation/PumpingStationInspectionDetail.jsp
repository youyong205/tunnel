...
<script type="text/javascript">
	$(document).ready(function() {
		...
		$('#lineType').val('<s:property value="pumpingStation.lineType"/>');
	});
</script>
</head>
<body>
  <div class="container">
	...
	<div>
		<ul class="breadcrumb">
			...
			<li><a href="userPumpingStationInspectionList.do?tunnelId=<s:property value="tunnelId"/>&tunnelSectionId=<s:property value="tunnelSectionId"/>">质量检查</a><span class="divider">/</span></li>
			...
			<div class="row-fluid">
			    <div class="span12">
					<a href="userPumpingStationList.do?tunnelId=<s:property value="tunnelId"/>&tunnelSectionId=<s:property value="tunnelSectionId"/>" class="btn btn-small  btn-primary btn-info">泵房列表</a>
    	  			<a href="userPumpingStationInspectionList.do?tunnelId=<s:property value="tunnelId"/>&tunnelSectionId=<s:property value="tunnelSectionId"/>" class="btn btn-small btn-primary btn-success ">质量检查</a>
      				<a href="userPumpingStationInspectionList.do?tunnelId=<s:property value="tunnelId"/>&tunnelSectionId=<s:property value="tunnelSectionId"/>" class="btn btn-small  btn-primary  btn-info">养护记录</a>
      			</div>
			</div>
