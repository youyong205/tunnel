  ...
  <div class="container">
	...
	<div class='row'>
		...
		<div class='span10'>
			<div class="row-fluid">
			    <div class="span12">
					<a href="userPumpingStationList.do?tunnelId=<s:property value="tunnelId"/>&tunnelSectionId=<s:property value="tunnelSectionId"/>" class="btn btn-small  btn-primary btn-success">泵房列表</a>
      				...
      				<a href="userPumpingStationCuringList.do?tunnelId=<s:property value="tunnelId"/>&tunnelSectionId=<s:property value="tunnelSectionId"/>" class="btn btn-small  btn-primary btn-info">养护记录</a>
      			</div>
      		</div>
      			<table  class="table table-striped table-bordered table-condensed">
					<tr>	
						<th colspan='4'><h4 class="text-info text-center">泵房信息详情</h4></th>
					</tr>
					<tr>
					...
					<tr>
						...
						<td ><input readonly type="text" name="pumpingStation.name" value="<s:property value="pumpingStation.name"/>"  class="{required:true,maxlength:64}"/></td>
						<td style="text-align:right;"><strong class="text-success">泵房类型</strong></td>
						<td ><input readonly type="text" name="pumpingStation.type"  value="<s:property value="pumpingStation.type"/>"  class="{required:true,maxlength:64}"/></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td><input readonly type="text" name="pumpingStation.startPosition"  value="<s:property value="pumpingStation.startPosition"/>" class="{required:true,number:true}"/></td>
						<td style="text-align:right;"><strong class="text-success">结束里程(m)</strong></td>
						<td><input readonly type="text" name="pumpingStation.endPosition"  value="<s:property value="pumpingStation.endPosition"/>"  class="{required:true,number:true}"/></td>
					</tr>
					<tr>
						...
						<td><textarea readonly type="text" rows="5" cols="30"  name="pumpingStation.des" class="{maxlength:512}"><s:property value="pumpingStation.des"/></textarea></td>
					</tr>
					</table>
