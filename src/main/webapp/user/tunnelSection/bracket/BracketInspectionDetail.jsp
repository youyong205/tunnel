...
<script type="text/javascript">
	$(document).ready(function() {
		...
		$('#lineType').val('<s:property value="bracket.lineType"/>');
	});
</script>
</head>
<body>
  <div class="container">
	...
	<div>
		<ul class="breadcrumb">
			...
			<li><a href="userBracketInspectionList.do?tunnelId=<s:property value="tunnelId"/>&tunnelSectionId=<s:property value="tunnelSectionId"/>">质量检查</a><span class="divider">/</span></li>
			...
			<div class="row-fluid">
			    <div class="span12">
					<a href="userBracketList.do?tunnelId=<s:property value="tunnelId"/>&tunnelSectionId=<s:property value="tunnelSectionId"/>" class="btn btn-small  btn-primary btn-info">牛腿列表</a>
      				...
      				<a href="userBracketInspectionList.do?tunnelId=<s:property value="tunnelId"/>&tunnelSectionId=<s:property value="tunnelSectionId"/>" class="btn btn-small  btn-primary  btn-info">养护记录</a>
      			</div>
			</div>
