  ...
  <div class="container">
	...
	<div>
		<ul class="breadcrumb">
			...
			<li><a href="userBracketCuringList.do?tunnelId=<s:property value="tunnelId"/>&tunnelSectionId=<s:property value="tunnelSectionId"/>">养护记录</a><span class="divider">/</span></li>
