...
<script type="text/javascript">
	$(document).ready(function() {
		...
		$('#longitudinalFault').addClass('active');
		$('#datetimepicker1').datetimepicker();
		$('#datetimepicker2').datetimepicker();
		var data = <s:property value='lineChart.jsonString' escape="false"/>;
		
		graphChartByDate("chart","纵缝错台趋势图","错台量Δz","(mm)",data.series);
		$('i[tips]').popover();
	});
</script>
...
<body>
  <div class="container">
	...
	<div class="row-fluid">
		...
		<div class='span10'>
			<form id="form" class="text-right form-inline margin-buttom"  action="userLongitudinalFaultQuery.do" method="post">
					<div>	<strong>从</strong>
               ...
               <div id="datetimepicker2" class="input-append date">
			    	...
			    	<h4 class='text-error text-center'>构件状态【第一块和第二块纵缝错台量显示在在第一块的状态上，以此类推】</h4>
	    			<table class="table table-striped table-bordered table-condensed table-hover">
	    				<tr><th style='text-align:right' width="25%">纵缝错台指标
