		...
		<div class='span10'>
			<div class="row-fluid">
			    <div class="span4">
					<a href="userLiningRingConstructionList.do?tunnelId=<s:property value="tunnelId"/>&tunnelSectionId=<s:property value="tunnelSectionId"/>" class="btn btn-small  btn-primary btn-info">衬砌环列表</a>
      				...
      				<a href="userLiningRingConstructionCuringList.do?tunnelId=<s:property value="tunnelId"/>&tunnelSectionId=<s:property value="tunnelSectionId"/>" class="btn btn-small  btn-primary btn-success ">养护记录</a>
      			</div>
				<div class="span8">
			...
			<table class="table table-striped table-bordered table-condensed table-hover">
				...
				<s:iterator value="curings" status="vs">
					...
					<td>
					<t:privilege res="衬砌环养护记录模块:详情">
						<a class="btn btn-small btn-success" href="userLiningRingConstructionCuringDetail.do?curingId=<s:property value="id"/>&index=<s:property value="index"/>&tunnelId=<s:property value="tunnelId"/>">详情</a>
					</t:privilege>
					</td>
					</tr>
				</s:iterator></tbody>
