	...
	<div class="row-fluid">
		...
		<div class='span10'>
			<form id="form" class="text-right form-inline margin-buttom"  action="userGirthFaultQuery.do" method="post">
               ...
               <div id="datetimepicker2" class="input-append date">
	    			...
	    			<table class="table table-striped table-bordered table-condensed table-hover">
	    				<tr><th width="25%" style='text-align:right'>环缝错台指标
			...
			<tr><td style='text-align:right'>构件状态</td>
   						<td><span class="level<s:property value="liningRingConstruction.girthFaultRingState.state"/>"><s:property value="liningRingConstruction.longitudinalFaultRingState.state"/></span></td>
	    				<s:iterator value="liningRingConstruction.girthFaultRingState.states">
